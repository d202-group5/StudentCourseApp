...
namespace StudentCourseApp.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Cname,Desc,Semester,PreReq,Compulsory,YearLevel")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,Cname,Desc,Semester,PreReq,Compulsory,YearLevel")] Course course)
        {
            if (id != course.Id)
            {
                return NotFound();
