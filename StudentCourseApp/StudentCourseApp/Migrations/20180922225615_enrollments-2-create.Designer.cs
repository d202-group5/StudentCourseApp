...
namespace StudentCourseApp.Migrations
{
    ...
    [Migration("20180922225615_enrollments-2-create")]
    partial class enrollments2create
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentCourseApp.Models.Enrollment", b =>
                {
                    ...
                    b.Property<string>("FutureEnroll");
            ...
            modelBuilder.Entity("StudentCourseApp.Models.TopicArea", b =>
                {
                    b.Property<int>("Id");
            ...
            modelBuilder.Entity("StudentCourseApp.Models.Course", b =>
                {
                    b.HasOne("StudentCourseApp.Models.TopicArea", "TopicA")
                        .WithMany("Course")
                        .HasForeignKey("TId")
